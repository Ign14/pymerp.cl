...
const CATEGORY_PUBLIC_LAYOUT_MAP: Partial<Record<CategoryId, PublicLayoutKey>> = {
  ...
  centros_estetica: 'barberiasShowcase',
  unas: 'barberiasShowcase',
  tatuajes_piercing: 'barberiasShowcase',
  ...
  restaurantes: 'restaurantesComidaRapidaShowcase',
  bares: 'restaurantesComidaRapidaShowcase',
  foodtruck: 'restaurantesComidaRapidaShowcase',
