    ...
    read(language: string, namespace: string, callback: (err: any, data: any) => void) {
      const es = {
        translation: {
          ...
          betaConditionsTitle: 'Condiciones de uso en beta',
          betaCondition1: 'La plataforma puede cambiar durante la beta.',
          betaCondition2: 'El servicio puede presentar interrupciones temporales.',
          betaCondition3: 'Tu información es tuya y está protegida.',
          betaCondition4: 'La información publicada es responsabilidad de cada usuario.',
          betaCondition5: 'Si se habilitan pagos, avisaremos con anticipación.',
      ...
      const en = {
        translation: {
          ...
          betaConditionsTitle: 'Beta terms',
          betaCondition1: 'The platform may change during beta.',
          betaCondition2: 'The service may have temporary interruptions.',
          betaCondition3: 'Your information is yours and protected.',
          betaCondition4: 'Published information is each user’s responsibility.',
          betaCondition5: 'If payments are enabled, we will notify you in advance.',
